...
TABLE_INDEXES = [
    ...
    'CREATE INDEX IF NOT EXISTS idx_alerts_user_id_id ON "alerts"("user_id", "id" DESC);',
    'CREATE INDEX IF NOT EXISTS idx_cves_ip_scan ON "cves"("ip", "scan_id");',
    'CREATE INDEX IF NOT EXISTS idx_cves_scan_id ON "cves"("scan_id");',
    'CREATE INDEX IF NOT EXISTS idx_host_user_id ON "host_status"("user_id");',
    'CREATE INDEX IF NOT EXISTS idx_host_user_id_id ON "host_status"("user_id", "id" DESC);',
    'CREATE INDEX IF NOT EXISTS idx_os_ip_scan ON "os_info"("ip", "scan_id");',
    'CREATE INDEX IF NOT EXISTS idx_os_scan_id ON "os_info"("scan_id");',
    ...
    'CREATE INDEX IF NOT EXISTS idx_risk_scan_id ON "risk_summary"("scan_id");',
    'CREATE INDEX IF NOT EXISTS idx_history_user_id ON "scan_history"("user_id");',
    'CREATE INDEX IF NOT EXISTS idx_history_user_id_id ON "scan_history"("user_id", "id" DESC);',
    ...
    'CREATE INDEX IF NOT EXISTS idx_ssl_host ON "ssl_results"("host");',
    ...
    'CREATE INDEX IF NOT EXISTS idx_url_user_id_id ON "url_scan_results"("user_id", "id" DESC);',
    ...
    'CREATE INDEX IF NOT EXISTS idx_serv_scan_port ON "service_versions"("scan_id", "port");',
    'CREATE INDEX IF NOT EXISTS idx_serv_ip_port ON "service_versions"("ip", "port");',
    'CREATE INDEX IF NOT EXISTS idx_ports_scan_port ON "ports"("scan_id", "port");',
    'CREATE INDEX IF NOT EXISTS idx_ports_ip_port ON "ports"("ip", "port");',
    'CREATE INDEX IF NOT EXISTS idx_vulns_scan_port ON "vulnerabilities"("scan_id", "port");',
    'CREATE INDEX IF NOT EXISTS idx_vulns_ip_port ON "vulnerabilities"("ip", "port");',
    'CREATE INDEX IF NOT EXISTS idx_cves_scan_port ON "cves"("scan_id", "port");',
    'CREATE INDEX IF NOT EXISTS idx_cves_ip_port ON "cves"("ip", "port");',
]
