...
TABLE_INDEXES = [
    ...
    'CREATE INDEX IF NOT EXISTS idx_services_scan_port ON "service_versions"("scan_id", "port");',
    'CREATE INDEX IF NOT EXISTS idx_host_target_ip ON "host_status"("target_ip");',
    'CREATE INDEX IF NOT EXISTS idx_history_target_ip ON "scan_history"("target_ip");',
]
