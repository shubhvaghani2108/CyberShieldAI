...
cursor.execute("DROP TABLE IF EXISTS risk_summary")
cursor.execute("DROP TABLE IF EXISTS scan_history")
cursor.execute("DROP TABLE IF EXISTS host_status")
cursor.execute("DROP TABLE IF EXISTS url_scan_results")
...
# ============================================================
cursor.execute("DROP TABLE IF EXISTS service_versions")
cursor.execute("""
...
# OS INFO TABLE
# ============================================================
cursor.execute("DROP TABLE IF EXISTS os_info")
cursor.execute("""
...
# SSL RESULTS TABLE
# ============================================================
cursor.execute("DROP TABLE IF EXISTS ssl_results")
cursor.execute("""
...
# ============================================================
cursor.execute("DROP TABLE IF EXISTS security_headers")
cursor.execute("""
...
# ============================================================
cursor.execute("DROP TABLE IF EXISTS technology_detection")
cursor.execute("""
...
# ============================================================
cursor.execute("DROP TABLE IF EXISTS url_intelligence")
cursor.execute("""
...
# ============================================================
cursor.execute("DROP TABLE IF EXISTS security_posture")
cursor.execute("""
...
# ============================================================
cursor.execute("DROP TABLE IF EXISTS virustotal_results")
cursor.execute("""
...
# ============================================================
cursor.execute("DROP TABLE IF EXISTS monitored_targets")
cursor.execute("""
...
print("CyberShield database reset successfully.")